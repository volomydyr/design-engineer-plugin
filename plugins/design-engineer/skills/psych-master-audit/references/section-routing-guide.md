...
|---------|------|------------|------------|
| 1. Fundamentals of Cognitive Interaction | 1-10 | `psych-cognitive-basics` | Mental load, choices, memory capacity, visual hierarchy, proximity, discoverability |
...
| 3a. Psychology of Decision-Making (Core) | 21-25 | `psych-decision-making-core` | Loss aversion, decision fatigue, anchoring bias, confirmation bias, default bias |
| 3b. Psychology of Decision-Making (Advanced) | 26-30 | `psych-decision-making-advanced` | Scarcity, social proof, authority bias, framing, availability heuristic |
| 4. Engagement and Motivation | 31-40 | `psych-engagement-motivation` | Flow state, variable reward, goal gradient, curiosity gap, aha moment, investment loops, triggers, Zeigarnik effect, feedback loops |
| 5a. Emotional Design (Core) | 41-45 | `psych-emotional-design-core` | Peak-end rule, delighters, sensory appeal, labor illusion, IKEA effect |
| 5b. Emotional Design (Advanced) | 46-50 | `psych-emotional-design-advanced` | Endowment effect, fresh start effect, storytelling effect, spacing effect, feedforward |
| 6. Efficiency Principles | 51-60 | `psych-efficiency` | Tesler's law, signifiers, skeuomorphism, Occam's razor, method of loci, exit points, law of the instrument, second-order effects, Weber's law, unit bias |
| 7a. Behavioral Economics (Core) | 61-65 | `psych-behavioral-economics-core` | Decoy effect, sunk cost effect, hyperbolic discounting, cashless effect, Pareto principle |
| 7b. Behavioral Economics (Habits) | 66-70 | `psych-behavioral-economics-habits` | Commitment and consistency, reciprocity, temptation bundling, pseudo-set framing, noble edge effect |
...
| 10. Time and Behavior Management | 91-100 | `psych-time-behavior` | Parkinson's law, chronoception, singularity effect, halo effect, spark effect, familiarity bias, juxtaposition, survivorship bias, attentional bias, shaping |
