...
description: Applies ethical design review to products and features using the Regret Test, Manipulation Matrix, Black Mirror Test, and Humane Design Principles. Use when auditing products for ethical concerns, reviewing dark patterns, or building humane products. Mark optional.
...
- **ux-bias-framework**: B.I.A.S. Act nudges need ethical review
