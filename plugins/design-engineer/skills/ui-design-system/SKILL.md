...
description: Guides creation of a code-first design system using atomic design patterns. Use when setting up a new project's design tokens, when auditing design system compliance, or when refactoring hardcoded styles into reusable tokens.
