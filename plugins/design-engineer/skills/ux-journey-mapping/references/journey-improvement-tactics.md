...
3. Design the transition to feel acknowledged:
   ...
   - Celebrate proportionally to the significance

**Questions to ask**:
- Is the user's commitment acknowledged at this moment?
...
## Tactic 2: Elevate the Peak

**What it means**: Find ways to make the highest moment even more memorable and delightful.

**Why it works**: Our brains remember the peaks really well. Because of the Peak-End Rule, a stronger Peak disproportionately improves how the user remembers the entire experience. It is more efficient to make a great moment even greater than to fix multiple small issues.

**How to apply**:

1. Identify the Peak moment in your journey
2. Ask: How could I make this moment even more memorable, surprising, or rewarding?
3. Consider:
   - Can you add a delighter (unexpected positive element)?
   - Can you amplify the reward the user receives?
   - Can you make the user feel more successful or accomplished?
   - Can you add social elements (sharing an achievement)?

**Questions to ask**:
- Think carefully about the customer's Motivations (Hopes, Fears)
- How does this Peak connect to what the user truly values?
- Could the Peak moment also serve as a transition into deeper engagement?

---

## Tactic 3: Fill the Biggest Pit
...
2. Understand the root cause:
   ...
   - Is the user being asked for too much commitment before receiving enough value?
3. Choose a strategy:
   - **Remove**: Can the step be eliminated entirely?
   - **Reduce**: Can the effort be reduced (fewer fields, simpler process)?
   - **Reframe**: Can the user's expectation be set differently?
   - **Reward**: Can you add a reward right before or during the difficult moment?
...
## Customer Journey Improvement Ideas Checklist
