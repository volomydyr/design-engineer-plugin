...
**How to identify**:
- Where does the user feel the most friction or frustration?
...
- Where does something unexpectedly good happen?
- Where does the user gain new motivation or confidence?

**What to look for**: The root cause of your biggest Jump often relates to context and user motivations. Understanding why a Jump happens helps you replicate that positive dynamic elsewhere.
...
**How to identify**: Focus on the most crucial Transitions from the perspective of the customer's motivations. Avoid getting lost in the micro-steps of your screens.

Ask yourself:
- Where does the user cross a threshold of commitment? (e.g., deciding to download, creating an account, making a payment)
...
A good customer journey map has **5 to 8 key moments**. You do not need to map every micro-interaction.

If you have too many moments, it means the slice of customer experience you are analyzing is too broad. Break it down into smaller sub-journeys.

If you have too few moments, you may be missing important emotional shifts. Look for hidden friction points or unacknowledged positive moments.

The following two graphs have 6 key moments (dots) in the same positions, but in the first graph with many additional intermediate points, it is much harder to analyze:

- A cluttered graph with dozens of points obscures the pattern
- A clean graph with 5-6 key moments reveals the emotional arc instantly
...
Arrange the identified moments into a structured table:

| # | Moment | Element Type | Delight Level | Description |
|---|--------|-------------|---------------|-------------|
| 1 | [Name] | [Peak/Pit/Jump/Drop/Transition] | [High/Medium/Low/Negative] | [What happens and how the user feels] |

Then describe the emotional arc: what goes up, what goes down, where the big shifts are, and how the experience ends.
