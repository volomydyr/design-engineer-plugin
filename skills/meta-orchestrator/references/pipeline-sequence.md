...
If "I need more time": save state, suggest compaction with compact-template.md, and make it easy to resume. The user will start a new session and run `/design-engineer:launch` to pick up at "designs ready for psychology review."
