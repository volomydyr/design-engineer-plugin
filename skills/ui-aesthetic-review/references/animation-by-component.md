...
This file provides exact timing for 10 component types. For general principles (easing selection, performance, springs), see [motion-design.md](./motion-design.md).
